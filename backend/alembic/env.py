...
# Resolution order: explicit DATABASE_URL env var (used by tests to point at the test DB) ->
# app Settings (which itself reads .env). Never hardcode a URL in alembic.ini.
